...
(function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    // preventDefault() cancels the browser's default in-page navigation, and
    // moving FOCUS is part of that default — not just the scroll. Without this,
    // the skip link scrolls the viewport to the content and leaves focus on the
    // link, so the very next Tab drops the user back into the nav they were
    // trying to skip. The link looks like it works and does nothing useful.
    //
    // -1 keeps the target out of the tab order while still making it focusable.
